...
namespace Dasher{
  namespace Settings {
	...
	const std::unordered_map<Parameter, const Parameter_Value> parameter_defaults = {
		...
		{BP_CONTROL_MODE         , Parameter_Value{"ControlMode"          , PARAM_BOOL, Persistence::PERSISTENT, false, "ControlMode"}},
		...
		{ SP_CONTROL_BOX_ID     , Parameter_Value{ "ControlBoxID"     , PARAM_STRING, Persistence::PERSISTENT, std::string("")              , "ControlBoxID" }},
