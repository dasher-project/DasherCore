...
TEST(draw_command_alignment) {
    ...
    dasher_destroy(ctx);
    printf("v draw_command_alignment passed\n");
}
...
TEST(draw_opcodes_in_range) {
    ...
    dasher_mouse_up(ctx);
    dasher_destroy(ctx);
    printf("v draw_opcodes_in_range passed\n");
}
...
TEST(draw_first_command_is_clear) {
    ...
    dasher_destroy(ctx);
    printf("v draw_first_command_is_clear passed\n");
}
...
TEST(draw_text_string_indices_valid) {
    ...
    dasher_destroy(ctx);
    printf("v draw_text_string_indices_valid passed\n");
}
...
TEST(draw_coordinates_in_bounds) {
    ...
    dasher_mouse_up(ctx);
    dasher_destroy(ctx);
    printf("v draw_coordinates_in_bounds passed\n");
}
...
TEST(draw_multiple_frames_consistent) {
    ...
    dasher_destroy(ctx);
    printf("v draw_multiple_frames_consistent passed\n");
}
...
TEST(draw_colors_have_alpha) {
    ...
    dasher_destroy(ctx);
    printf("v draw_colors_have_alpha passed\n");
}
...
TEST(draw_no_mouse_produces_idle_frame) {
    ...
    dasher_destroy(ctx);
    printf("v draw_no_mouse_produces_idle_frame passed\n");
}

int main() {
    printf("Running Dasher draw command tests...\n\n");

    test_draw_command_alignment();
    test_draw_opcodes_in_range();
    test_draw_first_command_is_clear();
    test_draw_text_string_indices_valid();
    test_draw_coordinates_in_bounds();
    test_draw_multiple_frames_consistent();
    test_draw_colors_have_alpha();
    test_draw_no_mouse_produces_idle_frame();

    printf("\nAll draw command tests passed!\n");
    return 0;
}
