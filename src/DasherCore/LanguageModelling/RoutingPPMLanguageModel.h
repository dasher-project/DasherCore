...
class CRoutingPPMLanguageModel : public CAbstractPPM {
  public:
    ...
    CRoutingPPMLanguageModel(CSettingsStore* pSettingsStore, const std::vector<symbol>* pBaseSyms,
                             const std::vector<std::set<symbol>>* pRoutes, bool bRoutesContextSensitive);
