...
CLanguageModel* LMRegistry::create(int id, CSettingsStore* settings, const CAlphInfo* alphInfo,
                                   const CAlphabetMap* alphMap, int numSyms) const {
...
struct StaticInit {
    StaticInit() {
        ...
        reg.registerLM({3,
                        "Mixture",
                        "PPM + Dictionary mixture",
                        true,
                        true,
                        {LP_LM_ALPHA, LP_LM_BETA, LP_LM_MAX_ORDER, LP_LM_MIXTURE, LP_LM_WORD_ALPHA, LP_LM_EXCLUSION,
