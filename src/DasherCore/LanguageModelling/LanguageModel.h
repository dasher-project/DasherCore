...
class Dasher::CLanguageModel {
  public:
    ...
    virtual bool WriteToFile(std::string strFilename) { return false; };

    virtual bool ReadFromFile(std::string strFilename) { return false; };
  ...
  protected:
    ...
    int GetSize() const { return m_iNumSyms + 1; }
