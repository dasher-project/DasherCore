...
/*COneDimensionalFilter::COneDimensionalFilter(CSettingsStore *pSettingsStore, CDasherInterfaceBase *pInterface,
CDasherModel *m_pDasherModel) : COneDimensionalFilter(pSettingsStore, pInterface, m_pDasherModel, 4, _("One Dimensional
Mode")) {
}*/
...
COneDimensionalFilter::COneDimensionalFilter(CSettingsStore* pSettingsStore, CDasherInterfaceBase* pInterface,
    ...
    : CDefaultFilter(pSettingsStore, pInterface, pFramerate, szName),
      forwardmax(static_cast<const Dasher::myint>(CDasherModel::MAX_Y / 2.5)) {}
...
C1DCircleStartHandler::C1DCircleStartHandler(COneDimensionalFilter* f, CSettingsStore* pSettingsStore)
    : CCircleStartHandler(f), m_pSettingsStore(pSettingsStore) {}
