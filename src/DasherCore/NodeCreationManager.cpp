...
CNodeCreationManager::CNodeCreationManager(CSettingsStore* pSettingsStore, CDasherInterfaceBase* pInterface,
    ...
    case CAlphInfo::RoutingContextSensitive:   // the user writes a symbol, is not dependent on context (e.g. just user
                                               // preference),
