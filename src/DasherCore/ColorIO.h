...
class CColorIO : public AbstractXMLParser {
  ...
  private:
    static ColorPalette::Color GetAttributeAsColor(pugi::xml_attribute attribute,
                                                   ColorPalette::Color defaultColor = ColorPalette::undefinedColor);
    static std::vector<ColorPalette::Color>
    GetAttributeAsColorList(pugi::xml_attribute attribute,
                            ColorPalette::Color defaultColor = ColorPalette::undefinedColor);
