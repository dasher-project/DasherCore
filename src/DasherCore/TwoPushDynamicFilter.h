...
class CTwoPushDynamicFilter : public CDynamicButtons {
  public:
    ...
    virtual void KeyDown(unsigned long Time, Keys::VirtualKey Key, CDasherView* pDasherView, CDasherInput* pInput,
                         CDasherModel* pModel) override;
    virtual void KeyUp(unsigned long Time, Keys::VirtualKey Key, CDasherView* pDasherView, CDasherInput* pInput,
                       CDasherModel* pModel) override;
  ...
  private:
    ...
    double m_dMinShortTwoPushTime, m_dMaxShortTwoPushTime, m_dMinLongTwoPushTime, m_dMaxLongTwoPushTime;
    int m_aiMarker[2];
    int m_iActiveMarker;
    int m_aiTarget[2];
