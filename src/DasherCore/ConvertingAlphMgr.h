...
class CConvertingAlphMgr : public CAlphabetManager {
  public:
    CConvertingAlphMgr(CSettingsStore* pSettingsStore, CDasherInterfaceBase* pInterface,
                       CNodeCreationManager* pNCManager, CConversionManager* pConvMgr, const CAlphInfo* pAlphabet);
