...
class Dasher::CDasherScreen {
  public:
    ...
    CDasherScreen(screenint width, screenint height) : m_iWidth(width), m_iHeight(height) {}
    ...
    screenint GetWidth() { return m_iWidth; }
    ...
    class Label {
      ...
      protected:
        Label(const std::string& strText, unsigned int iWrapSize) : m_strText(strText), m_iWrapSize(iWrapSize) {};
    ...
    virtual Label* MakeLabel(const std::string& strText, unsigned int iWrapSize = 0) {
        return new Label(strText, iWrapSize);
    }
    ...
    virtual void DrawString(Label* label, screenint x, screenint y, unsigned int iFontSize,
    ...
    virtual void DrawRectangle(screenint x1, screenint y1, screenint x2, screenint y2, const ColorPalette::Color& color,
                               const ColorPalette::Color& outlineColor, int iThickness) = 0;
    ...
    virtual void DrawCircle(screenint iCX, screenint iCY, screenint iR, const ColorPalette::Color& fillColor,
                            const ColorPalette::Color& lineColor, int iLineWidth) = 0;
    ...
    virtual void Polyline(point* Points, int Number, int iWidth,
                          const ColorPalette::Color& color = {255, 255, 255}) = 0;
    ...
    virtual void Polygon(point* Points, int Number, const ColorPalette::Color& fillColor,
                         const ColorPalette::Color& outlineColor, int lineWidth) = 0;
