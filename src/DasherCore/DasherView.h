...
class Dasher::CDasherView {
  public:
    ...
    CDasherScreen* Screen() const { return m_pScreen; }
    ...
    virtual void DasherSpaceArc(myint cy, myint r, myint x1, myint y1, myint x2, myint y2,
                                const ColorPalette::Color& color, int iLineWidth) const = 0;
    ...
    ///
    void DasherPolyarrow(myint* x, myint* y, int n, int iWidth, const ColorPalette::Color& color,
                         double dArrowSizeFactor = 0.7071) const;
    ...
    ///
    void DasherDrawRectangle(myint iDasherMaxX, myint iDasherMinY, myint iDasherMinX, myint iDasherMaxY,
    ...
    void DasherDrawCentredRectangle(myint iDasherX, myint iDasherY, screenint iSize, const ColorPalette::Color& color,
                                    const ColorPalette::Color& outlineColor, bool bDrawOutline) const;
    ...
    /// \return true if any part of the line was within the visible region; in this case, (x1,y1)-(x2,y2) delineate
    /// exactly that part false if the line would be entirely outside the visible region; x1, y1, x2, y2 undefined.
  ...
  protected:
    ...
    ///  \param x1 , y1 Dasher co-ordinates of start of line segment; note that these are guaranteed within
    ///  VisibleRegion.
