...
CUserLogBase::CUserLogBase(CDasherInterfaceBase* pInterface) : m_pInterface(pInterface), m_iNumDeleted(0) {
    m_pInterface->OnEditEvent.Subscribe(this,
                                        [this](CEditEvent::EditEventType type, const std::string&, CDasherNode* node) {
