...
class XMLUtil {
  public:
    ...
    static std::string GetElementString(const std::string& strTag, const std::string& strXML,
    ...
    static VECTOR_STRING GetElementStrings(const std::string& strTag, const std::string& strXML,
                                           bool bStripWhiteSpace = true);
