...
class CMandarinAlphMgr : public CAlphabetManager {
  ...
  public:
    ...
    CMandarinAlphMgr(CSettingsStore* pSettingsStore, CDasherInterfaceBase* pInterface, CNodeCreationManager* pNCManager,
  ...
  protected:
    ...
    ///  Overridden to call either CreateConvRoot or CreateCHSymbol, according to #chinese symbols under specified
    ///  pinyin
    ...
    void GetConversions(std::vector<std::pair<symbol, unsigned int>>& vChildren, symbol pySym,
